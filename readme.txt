...
КОММЕНТАРИЙ: при выводе количества лет при расчетах не учитываются високосные года.
...
КОММЕНТАРИЙ: в процессе выполнения расчеты получилось упаковать в цикл и упростить этим код.
